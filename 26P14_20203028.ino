...
// Servo range 
#define _DUTY_MIN 900                 //[3028] 서보 각도 최소값
#define _DUTY_NEU 1335    //[3038] 레일 수평 서보 펄스폭
#define _DUTY_MAX 1700    //[3031] 서보 최대값

// Servo speed control
#define _SERVO_ANGLE 30   //[3030] servo angle limit 실제 서보의 동작크기
          //[3023] 서보모터의 작동 범위(단위 : degree)
#define _SERVO_SPEED 35            // [3040] 서보의 각속도(초당 각도 변화량)
...
// PID parameters
#define _KP 1.5     //[3039] 비례 제어의 상수 값
#define _KD 110
